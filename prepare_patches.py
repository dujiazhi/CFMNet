...
if __name__ == "__main__":
	...
	parser.add_argument("--gray", default=False,\
	...
	if args.gray:
		if args.trainset_dir is None:
			args.trainset_dir = '.traindata/data3_gray'
		if args.valset_dir is None:
			args.valset_dir = './imagesets/Set12'
		traindbf = './train_gray.h5'
		valdbf = './val_gray.h5'

	else:
		if args.trainset_dir is None:
			args.trainset_dir = '.traindata/data3_rgb'
		if args.valset_dir is None:
			args.valset_dir = './imagesets/Kodak24'
